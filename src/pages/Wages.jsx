// Pay.jsx • Proago CRM (v2025-08-29i)
// Changes:
// • Heading remains “Pay from July 2025 • Bonus from June 2025” (dynamic)
...
export default function Pay({ recruiters, history }) {
  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="text-sm text-muted-foreground">
        <span>Pay from <b>{monthLabel(wagesMonth)}</b></span>{" • "}
                        ...
                        <div className="px-3 pb-3">
                          <div className="grid md:grid-cols-2 gap-3">
                            ...
                            <div className="border rounded-lg overflow-hidden">
                              <div className="px-3 py-2 bg-zinc-50 font-medium">Pay • {monthLabel(wagesMonth)}</div>
